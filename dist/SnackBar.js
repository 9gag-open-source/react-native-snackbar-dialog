...
var HIT_SLOP={top:8,bottom:8,left:8,right:8};
...
return(
_react2.default.createElement(_reactNative.TouchableOpacity,{hitSlop:HIT_SLOP,onPress:onPress},
...
_this.props,confirmText=_this$props3.confirmText,onConfirm=_this$props3.onConfirm,cancelText=_this$props3.cancelText,onCancel=_this$props3.onCancel,children=_this$props3.children,textColor=_this$props3.textColor;

var titleElement=_react2.default.createElement(_reactNative.Text,{style:[styles.text,{color:textColor}]},children);
...
_react2.default.createElement(_reactNative.Text,{style:[styles.inlineText,{color:textColor}]},children),
